...
<?php include 'header.php'; ?>
        ...
        <div class="container">
            <div class="cours-content">
                <div class="cours-text">
                    <h2>Cours intensifs de français</h2>
                    <p>Programme sur mesure pour expatriés avec progression rapide vers le niveau B2</p>
                    ...
                    <a href="/html2/cours-individuel" class="btn-gold">En savoir plus</a>
                </div>
                
                <div class="cours-image">
                    <img src="/public/img/cour-individuel2.jpeg" alt="Cours de français">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <p class="subtitle">Pour plus d'informations ou pour réserver votre premier cours</p>
        </div>
    </section>
